...
<table cellspacing=1 cellpadding=2 border=0 width=100% id=paidout10>
<tr>
...
<tr>
 <td>{$stats[s].username}</td>
 <td>{$stats[s].dd}</td>
 <td align=right><img src=images/{$stats[s].ec}.gif>{$currency_sign}{$stats[s].actual_amount}</td>
</tr>
{/section}
{else}
<tr>
