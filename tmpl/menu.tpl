<div class="mkd-menu-area" >
    <div class="mkd-grid">
        <form action="{$settings.site_url}/" class="mkd-search-cover" method="get">
        			...
        			<div class="mkd-form-holder-outer" role="search">
        				<div class="mkd-form-holder">
        					<div class="mkd-form-holder-inner">
        						...
        						<a class="mkd-search-submit" href="javascript:void(0)"><span class="arrow_carrot-right"></span></a>
        					</div>
        				</div>
        			</div>
        		</div>
        	</div>
        	<div class="mkd-search-close"><a href="#"><i class="mkd-icon-ion-icon ion-close " ></i></a></div>
        </form> 
                ...
                <div class="mkd-position-left-inner">
                    <nav class="mkd-main-menu mkd-drop-down mkd-default-nav">
                        <ul id="menu-main_menu" class="clearfix">
                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children mkd-active-item has_sub wide">
                                <a href="{$settings.site_url}" class="">
                                    <span class="item_outer">
                                        <span class="item_inner">
                                            <span class="menu_icon_wrapper"><i class="menu_icon null fa"></i></span>
                                            <span class="item_text">Home</span></span><span class="plus"></span>
                                        </span>
                            ...
                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children  has_sub wide">
                                <a href="{"?a=investment"|encurl}" class="">
                                    <span class="item_outer">
                                        <span class="item_inner">
                                            <span class="menu_icon_wrapper"><i class="menu_icon null fa"></i></span>
                                            <span class="item_text">Investment</span></span><span class="plus"></span>
                                        </span>
                                        <span class="bottom-border"><span class="bottom-border-inner"></span>
                                    </span>
                                </a>
                            ...
                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children  has_sub wide">
                                <a href="{"?a=faq"|encurl}" class="">
                                    <span class="item_outer">
                                        <span class="item_inner">
                                            <span class="menu_icon_wrapper"><i class="menu_icon null fa"></i></span>
                                            <span class="item_text">Faq</span></span><span class="plus"></span>
                                        </span>
                                        <span class="bottom-border"><span class="bottom-border-inner"></span>
                                    </span>
                                </a>
                            ...
                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children  has_sub wide">
                                <a href="{"?a=news"|encurl}" class="">
                                    <span class="item_outer">
                                        <span class="item_inner">
                                            <span class="menu_icon_wrapper"><i class="menu_icon null fa"></i></span>
                                            <span class="item_text">News</span></span><span class="plus"></span>
                                        </span>
                                        <span class="bottom-border"><span class="bottom-border-inner"></span>
                                    </span>
                                </a>
                            ...
                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children  has_sub wide">
                                <a href="{"?a=reviews_share"|encurl}" class="">
                                    <span class="item_outer">
                                        <span class="item_inner">
                                            <span class="menu_icon_wrapper"><i class="menu_icon null fa"></i></span>
                                            <span class="item_text">Reviews and Share</span></span><span class="plus"></span>
                                        </span>
                                        <span class="bottom-border"><span class="bottom-border-inner"></span>
                                    </span>
                                </a>
                            </li>
                            <li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home current-menu-ancestor current-menu-parent menu-item-has-children has_sub narrow">
                                <a href="{"?a=about_us"|encurl}" class=" current">
                                    <span class="item_outer">
                                        <span class="item_inner">
                                            <span class="menu_icon_wrapper"><i class="menu_icon null fa"></i></span>
                            ...
                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children  has_sub wide">
                                <a href="{"?a=signup"|encurl}" class="">
                                    <span class="item_outer">
                                        <span class="item_inner">
                                            <span class="menu_icon_wrapper"><i class="menu_icon null fa"></i></span>
                                            <span class="item_text">Sign up</span></span><span class="plus"></span>
                                        </span>
                                        <span class="bottom-border"><span class="bottom-border-inner"></span>
                                    </span>
                                </a>
                            ...
                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children  has_sub wide">
                                <a href="{"?a=login"|encurl}" class="">
                                    <span class="item_outer">
                                        <span class="item_inner">
                                            <span class="menu_icon_wrapper"><i class="menu_icon null fa"></i></span>
                                            <span class="item_text">Login</span></span><span class="plus"></span>
                                        </span>
                                        <span class="bottom-border"><span class="bottom-border-inner"></span>
                                    </span>
                                </a>
                            ...
                            {else}
                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children  has_sub wide">
                                <a href="{"?a=logout"|encurl}" class="">
                                    <span class="item_outer">
                                        <span class="item_inner">
                                            <span class="menu_icon_wrapper"><i class="menu_icon null fa"></i></span>
                                            <span class="item_text">Logout</span></span><span class="plus"></span>
                                        </span>
                                        <span class="bottom-border"><span class="bottom-border-inner"></span>
                                    </span>
                                </a>
