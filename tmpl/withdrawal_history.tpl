                    ...
                    <div class="wpb_wrapper">
                        ...
                        <table cellspacing="1" cellpadding="2" border="0" width="100%">
                            <tbody>
                                ...
                                <tr>
                                    <td class="table-text-center" nowrap="">{$t.d}</td>
                                    <td><b>{$t.transtype|escape:html}</b><br><small style="color: gray">{$t.description|escape:html}</small></td>
                                    ...
                                    <td class="table-text-right"><b>{$currency_sign}{$t.balance}</b></td>
                        ...
                        <table cellspacing="1" cellpadding="2" border="0" width="100%">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="table-text-right" width="200"><b>{$currency_sign} {$t.actual_amount}</b> <img src="images/{$t.ec}.gif" align=absmiddle hspace=1 height=17>{if $t.type == 'withdraw_pending'} <a href="{"?a=cancelwithdraw&id=`$t.id`"|encurl}" onclick="return confirm('Are you sure you want to delete this request?')">[cancel]</a>{/if}</td>
                                    <td class="table-text-center" width="170" valign=bottom><b><small>{$t.d}</small></b></td>
                                </tr>
                                <tr>
