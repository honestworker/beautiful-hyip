...
{/if}
 ...
 <td class=menutxt><br><a href="{"?a=earnings"|encurl}" class=menutxt>Earnings History</a></td>
</tr>{if $settings.use_referal_program == 1}<tr>
 <td class=menutxt><a href="{"?a=earnings&type=commissions"|encurl}" class=menutxt>Referrals History</a></td>
</tr>{/if}
<tr>
